...
export const fetchUserBorrowBooks = () => async (dispatch) => {
  ...
  await axios
    .get('http://13.201.100.192:4000/api/v1/borrow/my-borrowed-books', { withCredentials: true })
    .then((res) => {
...
export const fetchAllBorrowBooks = () => async (dispatch) => {
  ...
  await axios
    .get('http://13.201.100.192:4000/api/v1/borrow/borrowed-books-by-users', { withCredentials: true })
    .then((res) => {
...
export const recordBorrowBook = (id, email) => async (dispatch) => {
  ...
  await axios
    .post(
      `http://13.201.100.192:4000/api/v1/borrow/record-borrow-book/${id}`,
      { email },
      {
...
export const returnBook = (id, email) => async (dispatch) => {
  ...
  try {
    ...
    const response = await axios.put(
      `http://13.201.100.192:4000/api/v1/borrow/return-book/${id}`,
      { email },
      {
        withCredentials: true,
        headers: {
