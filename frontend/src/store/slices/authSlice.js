...
export const register = (data) => async (dispatch) => {
  ...
  await axios
    .post('http://13.235.69.70:4000/api/v1/auth/register', data, {
...
export const otpVerification = (email, otp) => async (dispatch) => {
  ...
  await axios
    .post(
      'http://13.235.69.70:4000/api/v1/auth/verifyOtp',
      { email, otp },
      {
        withCredentials: true,
        headers: {
...
export const login = (data) => async (dispatch) => {
  ...
  await axios
    .post('http://13.235.69.70:4000/api/v1/auth/login', data, {
      withCredentials: true,
      headers: {
        'Content-Type': 'application/json',
      },
...
export const logout = () => async (dispatch) => {
  ...
  await axios
    .get('http://13.235.69.70:4000/api/v1/auth/logout', {
      withCredentials: true,
    })
    .then((res) => {
...
export const getUser = () => async (dispatch) => {
  ...
  await axios
    .get('http://13.235.69.70:4000/api/v1/auth/me', {
      withCredentials: true,
    })
    .then((res) => {
...
export const forgotPassword = (email) => async (dispatch) => {
  ...
  await axios
    .post(
      'http://13.235.69.70:4000/api/v1/auth/password/forgot',
      { email },
      {
        withCredentials: true,
        headers: {
...
export const resetPassword = (data, token) => async (dispatch) => {
  ...
  await axios
    .put(`http://13.235.69.70:4000/api/v1/auth/password/reset/${token}`, data, {
      withCredentials: true,
      headers: {
        'Content-Type': 'application/json',
      },
...
export const updatePassword = (data) => async (dispatch) => {
  ...
  await axios
    .put(
      'http://13.235.69.70:4000/api/v1/auth/password/update',
      { data },
      {
        withCredentials: true,
        headers: {
