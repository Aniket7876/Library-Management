      ...
      <div className="w-11/12 bg-white rounded-lg shadow-lg sm:w-1/2 lg:w-1/3 2xl:w-1/3">
        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <p className="border-gray-300 rounded-lg px-4 py-2 bg-gray-100">{book && book.title}</p>
          </div>
          <div className="mb-4">
            <label className="block text-gray-700 font-semibold">Author</label>
            <p className="border-gray-300 rounded-lg px-4 py-2 bg-gray-100">{book && book.author}</p>
          </div>
          <div className="mb-4">
            <label className="block text-gray-700 font-semibold">Description</label>
            <p className="border-gray-300 rounded-lg px-4 py-2 bg-gray-100">{book && book.description}</p>
          </div>
        </div>
